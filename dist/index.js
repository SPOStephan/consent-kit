...
export { BUILT_IN_CATEGORIES, ConsentManager, GOOGLE_ADS_COOKIE_PATTERNS, GOOGLE_ANALYTICS_COOKIE_PATTERNS, acceptAll, autoTrackRouteChanges, defaultTexts, defineConfig, definePlugin, deleteCookies, formatText, getManager, getState, googleTagManager, hasConsent, init, loadScript, matchesPattern, notifyRouteChange, on, openSettings, rejectAll, resolveLanguage, resolveTexts, serviceCategories, setCategories, setService };
